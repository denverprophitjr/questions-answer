...
class DWQA_Akismet {
	...
	public function reported_list_admin() {
		$dwqa_reported_page = add_submenu_page( 'edit.php?post_type=dwqa-question', __( 'Report Spam List', 'dwqa' ), __( 'Report Spam', 'dwqa' ), 'manage_options', 'dwqa-report-spam-list', array(
			$this,
			'reported_list_admin_display'
		) );
	}
