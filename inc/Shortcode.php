...
class DWQA_Shortcode {
	...
	public function archive_question( $atts = array() ) {
		...
		wp_enqueue_script( 'dwqa-questions-list', DWQA_URI . 'templates/assets/js/dwqa-questions-list.js', array(
			'jquery',
	...
	public function submit_question_form_shortcode() {
		...
		ob_end_clean();
		wp_enqueue_script( 'jquery-ui-autocomplete' );
		wp_enqueue_script( 'dwqa-submit-question', DWQA_URI . 'templates/assets/js/dwqa-submit-question.js', array(
			'jquery',
			'jquery-ui-autocomplete'
		), $script_version, true );
