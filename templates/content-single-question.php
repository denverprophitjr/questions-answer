...
<article class="dwqa-question-item" itemscope itemtype="https://schema.org/Question">
    <meta itemprop="name headline" content="<?php single_post_title(); ?>"/>
    ...
    <div class="dwqa-question-meta">
		...
		<?php printf( __( '<span><a href="%s"><span itemprop="author" itemscope itemtype="http://schema.org/Person"><span itemprop="name">%s%s</span></span></a> %s asked %s ago</span>', 'dwqa' ), dwqa_get_author_link( $user_id ), get_avatar( $user_id, 48 ), get_the_author(), dwqa_print_user_badge( $user_id ), human_time_diff( get_post_time( 'U', true ) ) ) ?>
