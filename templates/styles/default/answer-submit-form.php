...
<div class="dwqa-answer-form">
    ...
    <form name="dwqa-answer-form" id="dwqa-answer-form" method="post" enctype="multipart/form-data">
		...
		<?php dwqa_init_tinymce_editor( array( 'content'       => $content,
		                                       'textarea_name' => 'answer-content',
		                                       'id'            => 'dwqa-answer-content'
		) ) ?>
		...
		<?php if ( dwqa_current_user_can( 'post_answer' ) && ! is_user_logged_in() ) : ?>
            <p>
                ...
                <input type="email" class="dwqa-question-anonymous-email" name="user-email"
        ...
        <input type="submit" name="submit-answer" class="dwqa-btn dwqa-btn-primary"
