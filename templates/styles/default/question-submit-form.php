...
<?php if ( dwqa_current_user_can( 'post_question' ) ) : ?>
    <form method="post" class="dwqa-content-ask-form" enctype="multipart/form-data">
        <p class="dwqa-search">
            ...
            <input type="text" data-nonce="<?php echo wp_create_nonce( '_dwqa_filter_nonce' ) ?>" id="question-title"
                   name="question-title" value="<?php echo esc_attr( $title ) ?>" tabindex="1">
        </p>
		<?php $content = isset( $_POST['question-content'] ) ? $_POST['question-content'] : ''; ?>
        <p><?php dwqa_init_tinymce_editor( array( 'content'       => $content,
		...
		<?php if ( dwqa_current_user_can( 'post_question' ) && ! is_user_logged_in() ) : ?>
            <p>
                ...
                <input type="email" class="dwqa-question-anonymous-email" name="_dwqa_anonymous_email"
            ...
            <p>
                ...
                <input type="text" class="dwqa-question-anonymous-name" name="_dwqa_anonymous_name"
        ...
        <input type="submit" name="dwqa-question-submit" class="dwqa-btn dwqa-btn-primary"
               value="<?php _e( 'Submit', 'dwqa' ) ?>">
